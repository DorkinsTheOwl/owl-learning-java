...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\programming\\java\\MusicDB\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIST_START = "SELECT " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME +
            " FROM " + TABLE_ALBUMS + " JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST +
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START = "SELECT " + TABLE_ARTISTS + "." + COLUMN_ALBUM_NAME + ", " +
            ...
            " JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + " = " + TABLE_ARTISTS + "." +
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                try {
                    Thread.sleep(20); // just to show progress bar
